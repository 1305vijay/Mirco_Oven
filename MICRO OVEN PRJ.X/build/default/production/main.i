...
void init_config()
{
    ...
    clcd_print("################",(0x80 + 0));
    clcd_print("   MICRO OVEN   ",(0xC0 + 0));
    clcd_print("  POWERING ON   ",(0x90 + 0));
    clcd_print("################",(0xD0 + 0));
...
void main(void) {
    ...
    char msg[]="0000";
    unsigned char control_flag = 0xAA;
    unsigned char key = 0;
    ...
    while (1)
    {
        ...
        switch(control_flag)
        {
...

            {
                ...
                {
                    clear_display();
                    clcd_print("It's ready",(0xC0 + 3));
                    clcd_print("Enjoy your food!", (0x90 + 0));
